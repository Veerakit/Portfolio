                    ...
                    <div className="max-w-[1000px] w-full grid gap-8 px-4">
                        ...
                        <div>
                            <p className="text-justify text-2xl indent-10 py-1">After graduated from the University, I felt my skills were not capable with the VUCA world. 
                                ...
                                Mainly use <span className="text-yellow-300">JavaScript</span>. Currently, learning <span className="text-yellow-300"> Cypress </span> 
                                and <span className="text-yellow-300"> Robot Framework</span>. Looking forward to learning about <span className="text-yellow-300">Software Testing</span>.
                            </p>
                        </div>
                    </div>
            </div>
